# -*- coding: utf-8 -*-
#This module is used to create ORM for mySQL
#add by dendi 2016/2/24
#first draft 
...
class BooleanField(Field):
	...
	def __init__(self,name=None,primary_key=False,default=True,ddl='boolean'):
		super().__init__(name,ddl,primary_key,default)
...
class TextField(Field):
	...
	def __init__(self,name=None,primary_key=False,default=0.0,ddl='text'):
		super().__init__(name,ddl,primary_key,default)
...
# def test(loop):
	# yield from create_pool(loop=loop,user='sa', password='password', db='db')
	# user = yield from User.find('123')
	# a=yield from User.findNumber('id','123')
	# print(a)
